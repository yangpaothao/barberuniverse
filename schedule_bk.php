...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function setthisDate(obj, thisrecno, thisday){
                //thisrecno is the barbar's recno in the users table
                //thisday is the n day of the calendar
                //We will need to get the year and the month from the dom
                $.post('<?=$_SERVER['PHP_SELF']; ?>', 'cmd=SetthisDate&thisrecno='+thisrecno+'&thisday='+thisday, function(result){  
...
{?>
    <div>
        <div>
            <button id="btn_setthisdate" class="float-right" style="height: 20px; width: 20px;" onclick="closeSetthisdate();">X</button>">
    ...
    <div class="div-pickedday-container" name="div_pickedday_container" id="div_pickedday_container" onmousedown="dragThis(this);">
        ...
        for($i=0; $i<count($slotarrayhr); $i++)
        {
            ...
            <div class="div-pickedday-container-header-body" name="div_pickedday_container_header<?php echo $counter ?>" id="div_pickedday_container_header-body<?php echo $counter ?>">
                <div class="div-pickedday-container-header-body-slots" id="div_slot_<?php echo $counter ?>"><?php echo ($slotarrayhr[$i])?> :</div>
...
function PaintCalendarDaily($thisrecno, $thiscurdate, $selectview, $thisday="", $from="")
{
    ...
    $divdayclass = "tbl-manage-schedule-calendar-dates-td-daily";
    $curmonthday = "";
                            ...
                            for($i=0; $i<count($slotarray); $i++) 
                            {
                                if(isset($d_array[$n][$slotarray[$i]][0]))
                                {
                                    ...
                                    <div>
                                        ...
                                        <span class="align-left" id="span_<?php echo $n ?>_v<?php echo $slotarray[$i] ?>">----Booked</span>
                                    </div><?php
                                    //$i++;
                                    if($i == 7)
                                    {?>
